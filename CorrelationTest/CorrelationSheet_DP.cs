    ...
    namespace Sheets
    {
        public class CorrelationSheet_DP : CorrelationSheet, IPairwiseSpec
        {
            ...
            private void AddUserControls()
            {
                ...
                vstoSheet.Controls.AddControl(btn_ConvertToDM, this.xlButton_ConvertCorrel.Resize[2,1], "ConvertToDM");
                ...
                btn_VisualizeCorrelation.Name = "btn_VisualizeCorrelation";
